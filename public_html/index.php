    ...
    <main class="flex-grow">
        <section class="max-w-7xl mx-auto px-4 py-16 lg:py-24">
            <div class="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
                ...
                <img src="assets/images/20260626_paco_v5_v3_upscale_v1.png" alt="Paco mascot" class="mx-auto h-[35rem] w-auto object-contain drop-shadow-3xl">
                ...
                <div class="space-y-8">
                    ...
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-amethyst leading-tight">
                        ...
                        <span class="text-lipstick text-shadow-lg/30">sostenibile</span> e <span class="text-chartreuse text-shadow-lg/30">trasparente</span>.
                    </h1>
        ...
        <section class="max-w-7xl mx-auto px-4 pb-20">
            <div class="grid gap-3 md:grid-cols-3 md:grid-rows-[20px_20px_minmax(100px,1fr)]">
                <h4 class="col-span-3 text-center">PERCHÉ PRIMEFACTORY</h4>
                <h2 class="col-span-3 text-center">Manifattura tecnica. Etica. Trasparente.</h2>
                <article class="h-full rounded-[1.5rem] border border-gray-100 bg-white/80 p-7 shadow-sm">
